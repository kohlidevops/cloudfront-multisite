...
exports.handler = (event, context, callback) => {
  ...
  const newSiteDomain = "cloudfront-new-site-lk.s3-website-us-east-1.amazonaws.com";
  const oldSiteDomain = "cloudfront-old-site-lk.s3-website-us-east-1.amazonaws.com";
